...
\begin{enumerate}
\item \textbf{EvAM-Tools: additional technical documentation:} Additional  documentation about EvAM-Tools. These include technical details (CPMs, error models, predicting genotype frequencies, generation of random evam models), and a FAQ. % application help but others apply to the package or to both.

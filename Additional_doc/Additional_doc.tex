...
This document provides additional documentation about EvAM-Tools, mainly intended to complement the Shiny web GUI application help. % To make access to all arguments of evamtools and its functions, this document should have, concatenated, the PDF from the R package itself. In , as well as an  PDF that explains the use of OncoSimulR for testing and how we use and interpret H-ESBCN to obtain transition rate matrices.

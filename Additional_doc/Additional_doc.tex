...
This document provides additional documentation about EvAM-Tools, mainly intended to complement the Shiny web GUI application help. You can run the app from \url{https://www.iib.uam.es/evamtools/} or download a Docker image from \url{https://hub.docker.com/r/rdiaz02/evamshiny}. 

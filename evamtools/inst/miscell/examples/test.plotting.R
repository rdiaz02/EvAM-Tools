...
plot_CPMs(sample_evam_output, samples=samples, methods=c("OT", "MHN", "CBN")
...
plot_CPMs(sample_evam_output, samples=samples, methods=c("OT", "CBN"), orientation="horizontal", plot_type = "obs_genotype_transitions", fixed_vertex_size=FALSE, top_paths = 1)
dev.off()

png("3_6_some_horizontal_obs_trans_tp2.png", width = 1000, height = 600, units = "px")
plot_CPMs(sample_evam_output, samples=samples, methods=c("OT", "CBN"), orientation="horizontal", plot_type = "obs_genotype_transitions", fixed_vertex_size=FALSE, top_paths = 2)
dev.off()

png("3_7_some_horizontal_obs_trans_tpnull.png", width = 1000, height = 600, units = "px")
plot_CPMs(sample_evam_output, samples=samples, methods=c("OT", "CBN"), orientation="horizontal", plot_type = "obs_genotype_transitions", fixed_vertex_size=FALSE, top_paths = NULL)
dev.off()

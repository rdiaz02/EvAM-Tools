...
Repo at \url{https://github.com/rdiaz02/OncoSimul}} to get accessible genotypes and transition matrices for CBN (and MCCBN), OT, HESBCN, and OncoBN. % I also clarify how our code interprets the output of HESBCN (not only as it concerns using OncoSimulR). 

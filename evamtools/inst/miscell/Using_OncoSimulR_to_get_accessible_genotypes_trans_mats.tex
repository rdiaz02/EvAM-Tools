...
\date{\today}
\title{Using OncoSimulR to get accessible genotypes and transition matrices, and obtaining transition rate matrices from H-ESBCN}
% \hypersetup{
...
\section{What about H-ESBCN/PMCE?}

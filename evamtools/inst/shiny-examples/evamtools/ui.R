                            ...
                            tags$div(id="all_advanced_options",
                                     tags$div(class="inlin",
                                           ...
                                           inputWithHelperUnbold(numericInput, "HyperTraPS_kernel", "kernel ",
                                                                 "(perturbation kernel): ", "The width of the MCMC kernel. The default of 5 should work well in most cases. Long periods of stasis on the likelihood trace (a horizontal line) indicate the MCMC acceptance rate is too low; in this case, use a smaller kernel.", 5, min=0),

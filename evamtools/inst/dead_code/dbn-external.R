## DBN has a package.
## This file can be safely removed. Kept here for historical purposes.
## This was the function as it was available in 
## https://github.com/phillipnicol/OncoBN
## As of 2021-10-03, commit hash 00daac6
## Copyright and author: Phillip B. Nicol <philnicol740@gmail.com>

## If we ever needed, we could use this function as it is released under the GPL
## 2 and thus compatible with out license.

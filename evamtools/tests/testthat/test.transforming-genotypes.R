test_that("Transforming 2binary works", {
    ...
    expect_error(suppressWarnings(int2binary(int_state5)))
    expect_error(suppressWarnings(str2binary(str_state5)))
})
...
test_that("Transforming to string works", {
    ...
    expect_error(suppressWarnings(int2str(int_state5)))
})
